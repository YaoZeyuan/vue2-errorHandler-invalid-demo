...
!(function (t, e) {
  ...
  function bn(t, e, n) {
    ...
    const errorHandler2Boolean = !!B.errorHandler
    const stringify2Boolean = JSON.parse(JSON.stringify(!!B.errorHandler))
    const rawBoolean = true

    console.log("errorHandler2Boolean is ", JSON.stringify(errorHandler2Boolean))
    if(errorHandler2Boolean){
      console.log("errorHandler2Boolean 为true")
    }else{
      console.log("errorHandler2Boolean 为false")
    }

    console.log("stringify2Boolean is ", JSON.stringify(stringify2Boolean))
    if(stringify2Boolean){
      console.log("stringify2Boolean 为true")
    }else{
      console.log("stringify2Boolean 为false")
    }
